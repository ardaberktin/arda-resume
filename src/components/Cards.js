        ...
        <div className="cards__wrapper">
          <ul className="cards__items">
            <CardItem
              ...
              label="Mobile App"
              path="/arda-resume/projects#mobile-apps&mot"
            />
            <CardItem
              src="images/Robber.jpg"
              text="2D Video Game Built With Java"
              label="Video Game"
              path="/arda-resume/projects#desktop-apps&robber"
            />
          </ul>
          <ul className="cards__items">
            <CardItem
