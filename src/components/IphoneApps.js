    ...
    <div className="iphone-container">
      ...
      <div className="iphone-wrapper">
        ...
        <div className="app-info">
          {selectedArea === 0 && (
            <>
              <h1>My iOS Apps are built on XCode with Swift and SwiftUI.</h1>{" "}
              <br />
              <h1>My Android App is built on Android Studio with Java.</h1>
            </>
          )}
          {selectedArea === 1 && (
            <div>
              ...
              <h1>
                Money on Track{" "}
                <a href={githubMOT} target="_blank" rel="noopener noreferrer">
          ...
          {selectedArea === 2 && (
            <div>
              ...
              <h1>
                MountDoug Maps - iOS{" "}
                <a href={githubMDM} target="_blank" rel="noopener noreferrer">
                  <GitHubIcon className="github-icon" />
                </a>
              </h1>
              <p>
          ...
          {selectedArea === 3 && (
            <div>
              ...
              <h1>
                ...
                <a href={githubMDM2} target="_blank" rel="noopener noreferrer">
                  <GitHubIcon className="github-icon" />
                </a>
              </h1>
              <p>
                • Created an app that shows each classroom on the map in my high
                school to help newcomers. <br />
              ...
              <div className="image-container">
                ...
                {currentImageIndex === 0 && (
                  <div className="app-image-info">
                    <h4 className="image-title">(1) Home View</h4>
                    <p>
                ...
                {currentImageIndex === 1 && (
                  <div className="app-image-info">
                    <h4 className="image-title">(2) Track View</h4>
                    <p>
                      Track your net worth, account balances and individual
                      transactions.
                    </p>
                  </div>
                )}
                {currentImageIndex === 2 && (
                  <div className="app-image-info">
                    <h4 className="image-title">(3) Budget View</h4>
                    <p>Compare your spending to your budget.</p>
                  </div>
                )}
                {currentImageIndex === 3 && (
                  <div className="app-image-info">
                    <h4 className="image-title">(4) Budget Buddy AI View</h4>
                    <p>
              ...
              <div className="image-container">
                ...
                {currentImageIndex === 0 && (
                  <div className="app-image-info">
                    <h4 className="image-title"> (1) Home View</h4>
                    <p>
                      Scroll or search to find the directions to the desired
                      classroom.
                    </p>
                  </div>
                )}
                {currentImageIndex === 1 && (
                  <div className="app-image-info">
                    <h4 className="image-title"> (2) Map View</h4>
                    <p>Follow the red arrow to the destination.</p>
                  </div>
                )}
                {currentImageIndex === 2 && (
                  <div className="app-image-info">
                    <h4 className="image-title"> (3) Favourites View</h4>
                    <p>
                      Add, remove or reorder your favourites to access them
                      easily.
                    </p>
                  </div>
                )}
              ...
              <div className="image-container">
                ...
                {currentImageIndex === 0 && (
                  <div className="app-image-info">
                    <h4 className="image-title">(1) Home View</h4>
                    <p>
                      Scroll to find the classroom and tap to see the location
                      on the map.
                    </p>
                  </div>
                )}
                {currentImageIndex === 1 && (
                  <div className="app-image-info">
                    <h4 className="image-title">(2) Map View</h4>
                    <p>Follow the arrow to arrive at the desired classroom.</p>
                  </div>
                )}
              </div>
            )}
